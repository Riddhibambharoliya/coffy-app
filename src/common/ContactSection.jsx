...
const ContactSection = () => {
    return (
        ...
        <div className=" mx-auto w-full border-t  px-4 lg:py-24 py-14 bg-[#f8f6f1]">
            ...
            <div className="text-center mb-16">
                ...
                <div className='flex justify-center items-center w-full'>
                    ...
                    <p className="text-sm text-gray-500 mt-4 lg:w-6/12">
            ...
            <div className="flex justify-center w-full px-5">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 2xl :w-9/12">
                    {/* Contact Address */}
