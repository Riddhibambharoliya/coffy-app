...
const ContactSection = () => {
    return (
        ...
        <div className=" mx-auto w-full border-t  px-4 py-24 bg-[#f8f6f1]">
{/* <p className=' divide-y'> */}
            ...
            <div className="text-center mb-16">
                ...
                <p className="text-sm text-gray-500 mt-4 w-6/12">
            ...
            <div className="flex justify-center">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 w-9/12">
                    {/* Contact Address */}
