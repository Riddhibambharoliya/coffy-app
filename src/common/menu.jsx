    ...
    <div className=" text-white  min-h-screen">
      ...
      >
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-gray-400 md:max-w-2xl mx-auto opacity-75 px-5">
            Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.
          </p>
        </div>

        <div className="flex md:flex-row flex-col justify-center gap-6 md:gap-8 lg:space-x-8 px-4 md:px-0 pb-8">
        ...
        <div className='flex justify-center items-center  md:pb-20 pb-10 '>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 w-10/12 ">
            <div className="flex justify-between md:flex-row flex-col items-start bg-opacity-60 py-4 border-b border-gray-600">
              ...
              <div className="text-xl text-white font-bold opacity-70 w-full flex justify-end md:w-fit">
                $12.00
              </div>
            </div>
            ...
            <div className="flex justify-between md:flex-row flex-col items-start bg-opacity-60 py-4 border-b border-gray-600">
              ...
              <div className="text-lg text-white font-bold opacity-70 w-full flex justify-end md:w-fit">
                $12.00
              </div>
            </div>
            ...
            <div className="flex justify-between md:flex-row flex-col items-start bg-opacity-60 pt-4  ">
              <div className="max-w-md">
