...
const BlogSection = () => {
    ...
    return (
        <div className="max-w-screen-xl mx-auto px-4 py-16 w-9/12">
            {/* Header Section */}
            <div className="text-center mb-16">
                <h2 className="text-4xl font-bold text-gray-800 py-6">OUR BLOGS</h2>
                <div className='flex justify-center items-center'>

                    <p className="text-base text-gray-500 mt-4 w-3/6  ">
